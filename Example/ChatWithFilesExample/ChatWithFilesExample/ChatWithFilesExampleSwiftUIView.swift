...
struct ChatWithFilesExampleSwiftUIView: View {
    ...
    @State private var folderTextIds: [UUID]?
...
//            TableColumn("Type") { diskItem in
//                let fileType = diskItem.fileUrl.pathExtension
//                Text("\(fileType.count > 0 ? fileType : "")")
//            }.width(100)
...
//             TableColumn("Processing Status") { diskItem in
...
//    }
//
//    private func fetchFolderContents() {
...
//
//    // Add your method for generating embeddings here
//    func generateEmbeddings(for item: URL) {
//        // Simulated embedding generation, replace this with your actual implementation
//        status = .generating
//        for i in 0...100 {
...
//            Spacer()
//
//            switch embeddingManager.status {
//            case .idle:
//                Button("Generate") {
//                    embeddingManager.generateEmbeddings(for: item)
//                }
//            case .generating:
//                ProgressView(value: embeddingManager.progress, total: 100)
//            case .completed:
